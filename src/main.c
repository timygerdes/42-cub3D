...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/31 18:05:04 by tgerdes           #+#    #+#             */
/*   Updated: 2022/05/17 14:56:19 by aignacz          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	In order to get a 2D map replace line 36 with the following line.
	There are two more places to change for the 2D map in start_game.
...
/*
	In order to get the 2D map replace line 67 with following line:
	mlx->mlx_win = mlx_new_window(mlx->mlx, mlx->width, mlx->height, "cub3D");
	And replace line 72 with following line:
	mlx_put_image_to_window(mlx->mlx, mlx->mlx_win, mlx->img.img, 0, 0);
*/
